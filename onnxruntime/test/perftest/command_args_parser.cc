...
/*static*/ void CommandLineParser::ShowUsage() {
  printf(
      ...
      "\t    [OpenVINO only] [use_compiled_network]: Can be enabled to directly import pre-compiled blobs if exists. currently this feature is only supported on MyriadX(VPU) and Intel's iGPU hardware device targets.\n"
