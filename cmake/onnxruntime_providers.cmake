...
#  include_directories("${CMAKE_CURRENT_BINARY_DIR}/onnx")
  ...
  get_target_property(ov_include openvino::runtime INTERFACE_INCLUDE_DIRECTORIES)
  endif()
  ...
  if ((DEFINED ENV{OPENCL_LIBS}) AND (DEFINED ENV{OPENCL_INCS}))
    ...
    list(APPEND OPENVINO_LIB_LIST ngraph::onnx_importer ${InferenceEngine_LIBRARIES} ${NGRAPH_LIBRARIES} ${PYTHON_LIBRARIES})
  endif()
 ...
 target_include_directories(onnxruntime_providers_openvino SYSTEM PRIVATE ${ov_include} ${ONNXRUNTIME_ROOT} ${CMAKE_CURRENT_BINARY_DIR} ${eigen_INCLUDE_DIRS} $ENV{OPENCL_INCS} ${InferenceEngine_INCLUDE_DIR})
  target_link_libraries(onnxruntime_providers_openvino ${OPENVINO_LIB_LIST} ${ONNXRUNTIME_PROVIDERS_SHARED} absl::raw_hash_set absl::hash)
