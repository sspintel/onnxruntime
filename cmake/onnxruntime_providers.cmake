...
#  include_directories("${CMAKE_CURRENT_BINARY_DIR}/onnx")
  ...
  elseif (OPENVINO_VERSION VERSION_GREATER_EQUAL "2022.1")
    list(APPEND OPENVINO_LIB_LIST ${InferenceEngine_LIBRARIES} ${NGRAPH_LIBRARIES} ngraph::onnx_ngraph_frontend ${PYTHON_LIBRARIES})
  else()
