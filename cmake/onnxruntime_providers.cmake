...
#  include_directories("${CMAKE_CURRENT_BINARY_DIR}/onnx")
  ...
  set(LANTERN_ROCK_INCLUDE_DIRS $ENV{LANTERN_ROCK_ROOT}/include)
  set(LANTERN_ROCK_LIB_DIRS $ENV{LANTERN_ROCK_ROOT}/bin/release)
  ...
  target_include_directories(onnxruntime_providers_openvino SYSTEM PUBLIC ${ONNXRUNTIME_ROOT} ${CMAKE_CURRENT_BINARY_DIR} ${eigen_INCLUDE_DIRS} ${OPENVINO_INCLUDE_DIR_LIST} ${PYTHON_INCLUDE_DIRS} ${LANTERN_ROCK_INCLUDE_DIRS})
  target_link_directories(onnxruntime_providers_openvino PRIVATE ${LANTERN_ROCK_LIB_DIRS})
  target_link_libraries(onnxruntime_providers_openvino onnxruntime_providers_shared ${OPENVINO_LIB_LIST} -lintel-ias3)
