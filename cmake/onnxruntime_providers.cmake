...
#  include_directories("${CMAKE_CURRENT_BINARY_DIR}/onnx")
  ...
  get_target_property(ov_include, openvino::runtime PROPERTY ${INTERFACE_INCLUDE_DIRECTORIES})
  ...
  if ((DEFINED ENV{OPENCL_LIBS}) AND (DEFINED ENV{OPENCL_INCS}))
    ...
    list(APPEND OPENVINO_LIB_LIST ngraph::onnx_importer)
  endif()
  ...
  target_include_directories(onnxruntime_providers_openvino SYSTEM PRIVATE ${ov_include} ${ONNXRUNTIME_ROOT} ${CMAKE_CURRENT_BINARY_DIR} ${eigen_INCLUDE_DIRS} ${PYTHON_INCLUDE_DIRS} $ENV{OPENCL_INCS} ${InferenceEngine_INCLUDE_DIR})
